                	...
                	<div id="content" class="col-lg-9 col-md-9 col-sm-9 col-xs-12 clearfix">
                    	<div class="blog_container clearfix">
						      <?php
								...
								extract($_REQUEST);
								$q=mysql_query("select * from advertisement order by id desc limit 18");
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-12">
                                <article class="blog-wrap boxes portfolio-wrap">
                                    ...
                                    <div class="post-content"> <h2><form action="property2.php?id=<?php echo $a['id'];?>" method="post"><a onClick="this.form.submit()" href=""> <?php echo $a['title'];?></a></form></h2>
                                    </div><!-- post-content -->
