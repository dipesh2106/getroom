				...
				<div class="modal-content">
                    ...
                    <div class="modal-body clearfix">
                    	<div class="text-left">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <form action="" method="post" name="contact.php" class="row" id="contact">
                                    ...
                                    <textarea class="form-control" name="description" id="comments" rows="6" placeholder="Description of your issue ...."></textarea>
				...
				<div class="modal-content">
                    ...
                    <div class="modal-body clearfix">
                    	<div class="text-left">
                           ...
                           <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <form action="" method="post" name="" class="row" id="contact">
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Name"> 
                                    <input type="text" name="email" id="email" class="form-control" placeholder="Email"> 
                                    <input type="text" name="phone" id="phone" class="form-control" placeholder="Phone"> 
                                    <textarea class="form-control" name="feedback" id="comments" rows="6" placeholder="Feedback ...."></textarea>
