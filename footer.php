            	...
            	<div class="row">
                	<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 first clearfix">
                   		<div class="widget clearfix">
                            ...
                            <ul class="list">
                            	...
                            	<li><a title="" href="about.php">About Us</a></li>
                            	<li><a title="" href="feedback.php">Feedback</a></li>
                            	<li><a title="" href="login.php">Login</a></li>
                            	<li><a title="" href="login.php">Register</a></li>
                            	<li><a title="" href="faqs.php">FAQs</a></li>
                            </ul>
                        </div>
                    </div>
                	<!-- end col-lg-3 -->
                	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 col-xs-12 clearfix">
                   		<div class="widget clearfix">
                            ...
                            <a href="about.php" class="btn btn-primary btn-sm">READ MORE</a>                        </div>
                    </div>
                	<!-- end col-lg-3 -->
                	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 col-xs-12 clearfix">
                   		<div class="widget clearfix">
