...
<head>
	...
	<title>GET ROOM ADs Listed</title>
                	...
                	<div id="content" class="col-lg-9 col-md-9 col-sm-9 col-xs-12 clearfix">
                    	<div class="blog_container clearfix">
						      <?php
								...
								extract($_REQUEST);
								$q=mysql_query("select * from advertisement where email='".$_SESSION['e']."'");
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-12">
                                <article class="blog-wrap boxes portfolio-wrap">
                                    ...
                                    <div class="post-content"> <h2><a href="singlead.php?id=<?php echo $a['id'];?>"> <?php echo $a['title'];?></a></h2>
                                    </div><!-- post-content -->
