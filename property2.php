                	...
                	<div id="content" class="col-lg-7 col-md-6 col-sm-6 col-xs-12 clearfix">
                    	<div class="property_wrapper boxes clearfix">
							...
							<div class="title clearfix">
                            	...
                            	<h3> <?php echo $b['title'];?> 
                                <small><mark><i class="fa fa-inr"></i> <?php echo $b['price'];?></mark></small>
                                </h3>
							</div><!-- end title -->

							<div class="boxed_mini_details1 clearfix">
								<span class="type first"><strong>Category</strong><a> <?php echo $b['category'];?></a></span>
								<span class="sqft"><strong>Status</strong> <a><?php echo $b['status'];?></a></span>
                            ...
                            <div class="property_map clearfix">
                            	<h3 class="big_title">Property Address<small>Reach the place at address .... </small></h3>
                             	<a class="alert-success"><?php echo $b['address'];?></a>
                            </div>
							<hr>
                            <div>
						    ...
						    ?>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="boxes">
                                        ...
                                        <h2 class="title"><a href="property2.php?id=<?php echo $a['id'];?>"> <?php echo $a['title'];?></a></h2>
                                    </div><!-- end boxes -->
                                </div>
                			<?php
							}
